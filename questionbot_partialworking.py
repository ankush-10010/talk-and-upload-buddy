...
class QueryBot:
    def __init__(self,
                 ...
                 groq_api_key="gsk_Bhj02RbwcxudTbokfzrjn",
...
# question_bot=QuestionPaperBot("gsk_UZDP8vKlnGPiU2c5uqS")
...
#how to use
  ...
  # bot = QuestionPaperBot(groq_api_key="gsk_UZDP83qvKlnGPiU2c5uqS")
...
# scheduler_bot=Scheduler("gsk_UZDP83KlnGPiU2c5uqS")
...
class RouterAgent:
    def __init__(self, groq_api_key=None, model="llama-3.1-8b-instant"):
        self.api_key = groq_api_key or os.getenv("gsk_UZDcvKlnGPiU2c5uqS")
...
router_agent = RouterAgent("gsk_UZDP83lnGPiU2c5uqS")
...
import nest_asyncio
!ngrok authtoken 2xNBjsJZTEMSyZauzLBSHA8EJvn
...
# router=RouterAgent("gsk_UZDP83lnGPiU2c5uqS")
# prompt=input("Prompt")
